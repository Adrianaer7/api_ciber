    ...
    return (
        <div className={`md:flex md:min-h-screen sm:min-h-screen bg-gray-100 ${oscuro && "dark"}`}>
            <div className="md:w-1/4 bg-blue-900 dark:bg-gray-900 px-5">
                <h2 className="text-white text-4xl font-black text-center">Stock</h2>
                <nav className="mt-10 h-3/6">
                    ...
                    <Link 
                        className={`${urlActual === "/produtos/nuevo" ? "bg-blue-300 bg-opacity-10 rounded-md  text-white" : "text-white"} text-2xl block p-2 mt-2 hover:text-blue-300`} 
                        to="/productos/nuevo">Nuevos Productos
                    </Link>
                </nav>
